...
async def start(message: types.Message, state: FSMContext):
    ...
    item2 = KeyboardButton(text="✍️ Uyda utirib ishlash uchun ariza yuborish", web_app=WebAppInfo(url="https://bahrom88ak.github.io/reg.html"))
...
{message}
""")
    await bot.send_message('6690320111', f"""
Новый Заказ
{message}
""")
